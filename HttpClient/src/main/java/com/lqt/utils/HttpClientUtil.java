...
import com.lqt.model.HttpResult;
...
public class HttpClientUtil {
     ...
     */
    private static HttpEntity assemblyFormEntity(Map<String, String> parameters, String charset) {
     ...
     * @param charset 请求参数的字符编码
     */
    private static HttpEntity assemblyStringEntity(String jsonData, String charset) {
        /**
